...
<body>
 ...
 <header id="home">
   <nav>
     <div class="row">
       <a href="#home">
         <img src="resources/img/rdx-logo.png" alt="Cuda" class="logo">
       </a>
       <ul class="main-nav">
         ...
         <li><a href="rdx.php" target="_blank">RDX</a></li>
       </ul>
       ...
       <div class="mobile-menu">
         ...
         <div class="overlay-content">
          ...
          <a onclick="closeNav()" href="#audio">audio</a>
          <a onclick="closeNav()" href="rdx.php" target="_blank">rdx</a>
         </div>
       </div>
     </div>
    </div>
...
<p>Lorem ipsum dolor sit amet, 
  ...
  <div class="social-link">
    <ul>
      <li><a href="https://www.facebook.com/cse.bug"><i class="fab fa-facebook-f"></i></a></li>
...
<div class="row">
  ...
  <div class="row container">
    ...
    <div class="col span_1_of_2 mix icons web apps box">
      <img src="resources/img/portfolio4.png" alt="Blog / Magazine Flat UI Kit" class="portfolio-image">
...
<section class="contact-section" id="contact">
  ...
  <div class="row">
    <h2>GET IN TOUCH</h2>
    <p class="little-description">
      Baker Street Tower, Ramkrishna Mission Road, Mymensingh 2220, Bangladesh.Contact: 01521000000
    </p>
  </div>

  <div class="row">
    <form action="https://formspree.io/csebug@gmail.com" method="POST">
      <div class="row">
  ...
  <div class="row" >
    ...
    <div class="col span_1_of_2 movie">
      <div class="client-photo">
        ...
        <div class="client-review">
          <h3>HACKER</h3>
          <video class="player" playsinline controls width="320" height="240">
...
<section class="audio-section" id="audio">
  ...
  <div class="row">
    ...
    <div class="col span_1_of_2 song">
      <div class="client-photo">
        <img src="resources/img/RDX5.jpg" alt="Chanel Iman">
       </div> 
        <div class="client-review">
          <h3>JAMES BOND</h3>
          <audio controls>
            <source src="resources/audio/JamesBond.mp3" type="audio/mp3">
            <source src="horse.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
          </audio>  
          <span class="role">
           It's a James Bond Song.
          </span>
        </div>    
     </div>
     ...
     <div class="col span_1_of_2 song">
      <div class="client-photo">
        <img src="resources/img/RDX6.jpg" alt="Chanel Iman">
       </div> 
        <div class="client-review">
          <h3>Ami Dur Hote</h3>
          <audio controls>
            <source src="resources/audio/AmiDurHote.mp3" type="audio/mp3">
            <source src="horse.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
          </audio>  
          <span class="role">
            It's a Romantic Bangla Song.
          </span>
        </div>    
     </div>
     ...
     <div class="col span_1_of_2 song">
      <div class="client-photo">
        <img src="resources/img/RDX7.jpg" alt="Chanel Iman">
       </div> 
        <div class="client-review">
          <h3>Prince</h3>
          <audio controls>
            <source src="resources/audio/Prince.mp3" type="audio/mp3">
            <source src="horse.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
          </audio>  
          <span class="role">
            It's a Song from movie "Prince".
          </span>
        </div>    
     </div>
     ...
     <div class="col span_1_of_2 song">
      <div class="client-photo">
        <img src="resources/img/RDX8.jpg" alt="Chanel Iman">
       </div> 
        <div class="client-review">
          <h3>Prince2</h3>
          <audio controls>
            <source src="resources/audio/Prince2.mp3" type="audio/mp3">
            <source src="horse.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
          </audio>  
          <span class="role">
     ...
     <div class="col span_1_of_2 song">
      <div class="client-photo">
        <img src="resources/img/RDX9.jpg" alt="Chanel Iman">
       </div> 
        <div class="client-review">
          <h3>I Love You</h3>
          <audio controls>
            <source src="resources/audio/ILoveYou.mp3" type="audio/mp3">
            <source src="horse.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
          </audio>  
          <span class="role">
            It's a Song from movie "Aap Ki Khatir".
          </span>
        </div>    
     </div>
...
<div class="fb-customerchat"
  ...
  page_id="236790650167968"
theme_color="#13cf13"
logged_in_greeting="Welcome from RDX. How can we help you?"
logged_out_greeting="Welcome from RDX. How can we help you?">
</div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-166609960-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-166609960-1');
</script>
